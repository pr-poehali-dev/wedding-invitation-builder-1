...
export function mergeWithDefaults(parsed: Partial<WeddingData>): WeddingData {
  return {
    ...
    dressCodeColors: Array.isArray(parsed.dressCodeColors) ? parsed.dressCodeColors : WEDDING_DEFAULTS.dressCodeColors,
    programLines: Array.isArray(parsed.programLines) ? parsed.programLines : WEDDING_DEFAULTS.programLines,
    timelineTitles: Array.isArray(parsed.timelineTitles) ? parsed.timelineTitles : WEDDING_DEFAULTS.timelineTitles,
    timelineTexts: Array.isArray(parsed.timelineTexts) ? parsed.timelineTexts : WEDDING_DEFAULTS.timelineTexts,
